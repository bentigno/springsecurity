...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/accueil").hasAnyAuthority("ROLE_USER");
		http.authorizeRequests().antMatchers("/admin/users").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER");
		//gestion des droits
